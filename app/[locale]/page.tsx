...
import { CheckBox, FontListCard, FramerMotionWrapper, RivLoading } from '@components/index';
...
import { CheckedContext, FontListContext, FontSizeContext, IsWinFontContext, SearchContext, ValueContext } from './Providers';
...
export default function Home() {
  ...
  const onClickFont = (font: FontType) => {
    ...
    router.push(`/fonts/${font.nameEn}`);
    fbEvent('Click', { content_name: font.nameEn });
    
    font.fontSupportType.toLocaleLowerCase() === 'win' ? setIsWinFont(true) : setIsWinFont(false);
  };
  ...
  return (
    <main className="flex-grow xl:mt-28 ">
      <FramerMotionWrapper>
        ...
        <div className="md:min-h-[1000px] min-h-[800px]">
          <div className="lg:w-[996px] max-w-[996px] sm:mx-10 md:mx-24 lg:mx-auto lg:mt-10 mx-5 ">
            <div className="flex flex-row items-center mt-16 xl:mt-10">
